class CategoryController < ActionController::Base
  ...
  def index
    ...
    @video_forces.each do |_|
      flow_medias[:videos] << {medial_type: "video", medial_id:_.id, title:_.title,url:_.url,mobile_url:_.mobile_url,local_image_url:_.local_image_url,tag_ids:_.tags_str, web_target:"Youtube", web_target_logo: "https://sz6.je2ci9.com/infoflow_pics/strategy/aclconf/0127741811_Youtube@2x.png",overlay_time: _.overlay_time, play_count:_.play_count }
    end
    # 视频
    @videos.each do |_|
